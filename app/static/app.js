...
const signedOutBox = requireElement("signed-out");
const signedInBox = requireElement("signed-in");
const signinForm = requireElement("signin-form");
const userInput = requireElement("user");
const passwordInput = requireElement("password");
const loginButton = requireElement("login");
const registerButton = requireElement("register");
const logoutButton = requireElement("logout");
const whoamiBox = requireElement("whoami");
...
async function signIn(route) {
    ...
    try {
        ...
        showAs((await response.json()).user);
    }
    catch {
