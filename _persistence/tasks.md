...
| T-068 | Lista de **"ESTO NUNCA SE TOCA"** en el documento de clics de `deploy/`, con los nombres escritos: AWS Organization, Control Tower, Partner Network. 🚨 Cruzan al plan de pago **sin pedir confirmación**, evaporan los créditos y **no tienen vuelta atrás** (`C-005`). No son botones que se vayan a necesitar: son botones con los que uno **se cruza**. ⚠️ Antes de escribirla, cerrar `A-016` leyendo entera la elegibilidad de la FAQ — la lista de tres puede estar incompleta, y una lista incompleta tranquiliza sin proteger | 🔲 | 7 |
