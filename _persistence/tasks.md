...
| T-095 | 🟡 **ABIERTA, con lectura PARCIAL tomada el 2026-08-14 a las 15:08 UTC. Falta UN CLIC.** Estado exacto: banda sellada en `[D-079]`, lectura parcial hecha, **falta el costo del día 14 AISLADO** — ni "cuadró" ni "no cuadró". ✅ Lo ya leído: el día 14 sale **limpio al token** (`21.668 \| 2.959`, idéntico a `T-093` — no hay nada que descontar), y la semana leída (**`$0,20`**) **valida las tarifas unitarias** contra un mix distinto del que las originó. 🚨 **Pero ese `$0,20` es de "últimos 7 días", no del día 14:** el número del día sigue **derivado**, y cerrar con él es lo que prohíbe la regla 6. 👉 **Lo que falta:** vista de COSTO → gráfica *"Costo diario de tokens"* → leer la **barra del 14 de agosto** (o rango personalizado 14→14). 🔮 **Dos predicciones ya selladas en `[D-079]`, y no son la misma** — derivación completa `$0,18–$0,19` y por resta `$0,177–$0,187`, esta última más fuerte: **ábrelas antes de mirar**. 👤 La lectura la hace el estudiante: es su cuenta y cuesta $0 | 🟡 | 8 |
