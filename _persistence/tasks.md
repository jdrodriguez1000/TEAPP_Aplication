...
| T-106 | 🟢 **DESBLOQUEADA por `T-107`, va DESPUÉS de la corrida de 60.** Etiquetar a mano las 60 frases de la línea base (o leerlas) para medir si el veredicto del juez ACIERTA, si corrigió uno o tres errores, o si se fue del tema — las tres promesas de `GRAMMAR_RUBRIC` que un programa no puede comprobar solo | 🔲 | 9 |
